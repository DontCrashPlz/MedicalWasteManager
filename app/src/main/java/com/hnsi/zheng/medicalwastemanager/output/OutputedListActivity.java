...
import com.hnsi.zheng.medicalwastemanager.input.InputedBucketDetailActivity;
...
public class OutputedListActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("已出库医废");
            getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        }

        mCollectInfos= getIntent().getStringExtra("output_person_info").split("_");
...
//        requestInputedList(null);
    ...
    private void requestOutputedList(@Nullable String key){
        addNetWork(Network.getInstance().getOutputedList(mOrgId, mUserId, key)
