...
public class BucketNfcReadActivity extends BaseNfcActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("医废桶打码");
...
//        Ndef ndef= Ndef.get(detectedTag);
        ...
        Intent infoIntent= new Intent(getRealContext(), PrintBucketQRCodeActivity.class);
        infoIntent.putExtra("operate_person_info", mCardText);
