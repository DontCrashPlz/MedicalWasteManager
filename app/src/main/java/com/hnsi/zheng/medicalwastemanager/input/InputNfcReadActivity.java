...
public class InputNfcReadActivity extends BaseNfcActivity {
...
//        Ndef ndef= Ndef.get(detectedTag);
        ...
        Intent infoIntent= new Intent(getRealContext(), InputMainActivity.class);
        infoIntent.putExtra("input_person_info", mCardText);
